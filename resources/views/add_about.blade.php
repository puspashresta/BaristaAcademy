...
@section('content')
    <div class="container">
        <div>
            <form action="about_content" method="post"  enctype="multipart/form-data" >
                @csrf
                <div class="form-group">
                    <div id="formdiv">
                        ...
                        <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 offset-md-1">
                                <p style="margin-left:2%;font-family:Roboto, sans-serif;font-size:24px;"><strong>Established On:</strong></p>
                            </div>
                            <div class="col-md-10 offset-md-1"><input class="form-control" type="date" name="founded_date" style="font-family:Roboto, sans-serif;"></div>
                        </div>
                      <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 offset-md-1">
                        ...
                        <div class="form-group"><textarea class="form-control" rows="10" name="description" placeholder="Message"></textarea></div>
                        </div>
